        ...
        <div className="hidden lg:block">
          <div className="absolute lg:pt-0 lg:right-5 right-1/2 translate-x-1/2 lg:translate-x-0 lg:top-1/2 -translate-y-1/2 flex items-center lg:items-start lg:flex-col mt-12 lg:mt-0 gap-x-2 lg:space-y-2">
            <a target="_blank" href="mailto:contact@bragaexperience.com">
              <Mail size={35} className="p-0.5 rounded-sm text-white/70" />
            </a>
            <a target="_blank" href="https://www.youtube.com/@lucasbraga1230">
              <Youtube size={40} className="p-0.5 rounded-sm text-white/70" />
            </a>
            <a target="_blank" href="https://www.instagram.com/bragaexp">
              <Instagram size={35} className="p-0.5 rounded-sm text-white/70" />
            </a>
            <a
              target="_blank"
              href="https://www.linkedin.com/in/lucas-braga-50970a35a/"
            >
              <Linkedin size={35} className="p-0.5 rounded-sm text-white/70" />
            </a>
          </div>
        </div>
      </div>
